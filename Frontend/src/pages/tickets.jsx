...
const handleSaveTicket = () => {
  ...
  <thead className="table-dark">
      ...
      <button onClick={handleCreateTicketClick} className="btn btn-primary" style={{backgroundColor:'purple', outlineColor:'purple'}}>Create New Ticket</button>
      </div>
<div>
  {ticketModalVisible && (
...
{ticketModalVisible && (
  ...
  <label htmlFor="floatingTextarea2">Comments</label>
            ...
            <button onClick={handleSaveTicket} className="btn btn-success" >Save</button>
