...
`;
    ...
    const subcategoryInfo = {
        "Desktops": "Information about Desktops",
        "Laptops": "Information about Laptops",
        "Printers": "Printers",
	    "Servers": "Servers",
	    "Networking Equipment": "NE",
	    "Email Issues": "Email Issues",
	    "Internet Connection Problems": "ICP",
    ...
    const renderSubcategoryInfo = () => {
        if (selectedSubcategory && subcategoryInfo[selectedSubcategory]) {
            return (
                <div className="ms-5 mt-3">
                    <p>{subcategoryInfo[selectedSubcategory]}</p>
                </div>
            );
        }
        return null;
    ...
    return (
        <>
                                        ...
                                        <div style={{ position: 'absolute', top: '30px', right: '-200px', width: '200px', height: '100px', backgroundColor: 'white', boxShadow: '0px 0px 5px rgba(0, 0, 0, 0.2)', borderRadius: '0px', padding: '10px' }}>
                                            ...
                                            <div style={{ display: 'flex', alignItems: 'center' }}>
                                                ...
                                                <div>
                                                    ...
                                                    <br />
                                                    <Link to="/" style={{ color: 'purple', textDecoration: 'none' }}>Logout</Link>
                                                </div>
                                            </div>
                                        </div>
                                    )}
            ...
            <h3 style={{ textAlign: "left", margin: "40px", color: 'purple', fontFamily: "sans-serif", fontWeight: "bold" }}>
                Can't find what you're looking for? Search our FAQs below!
            </h3>
            {/* Search bar */}
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'flex-start', marginLeft: '90px' }}>
                <InputGroup style={{ width: '400px', height: '50px', marginTop: "-5px", marginLeft: "-45px"}}>
                    <FormControl
                        placeholder="My Laptop Froze!"
                        aria-label="Search FAQ"
                        aria-describedby="basic-addon2"
                    />
                    <InputGroup.Text id="basic-addon2" style={{ cursor: 'pointer' }} onClick={() => console.log('Perform search')}>
                        <FaSearch />
                    </InputGroup.Text>
                </InputGroup>
            </div>
            {/* Categories and Subcategories */}
            <div className="d-flex flex-column align-items-start mt-4 ms-5">
                <div className="mb-3">
