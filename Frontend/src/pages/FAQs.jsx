...
export default function HomePage() {
    ...
    return (
        <>
            ...
            <h3 style={{ textAlign: "left", margin: "40px", color: 'black', fontFamily: "Times New Roman", fontWeight: "lighter" }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'flex-start', marginLeft: '90px' }}>
                <InputGroup style={{ width: '400px', height: '50px' }}>
                    ...
                    />
                    <InputGroup.Text id="basic-addon2" style={{ cursor: 'pointer' }} onClick={handleSearch}>
                        <FaSearch />
                    </InputGroup.Text>
                </InputGroup>
            </div>
