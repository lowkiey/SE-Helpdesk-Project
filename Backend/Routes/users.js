...
// * Get one user
router.get("/:id", authorizationMiddleware(['user','admin']), userController.getUser);
...
router.post("/assign", authorizationMiddleware(['user','admin']), userController.updateRole);
